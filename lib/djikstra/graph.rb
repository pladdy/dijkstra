...
module Djikstra
  class Graph    
    ...
    ##
    # creates a new Djikstra::Node object and stores in a hash with the label
    # as the key
    def add_node(label)
    ...
    ##
    # return a Djikstra::Node given a label
    def get_node(label)
      @nodes[label]
    end
    ...
    ##
    # implements djikstras algorithm (breadth first search) to find
